...
$(function () {
    ...
    [].concat((0, _toConsumableArray3.default)(s)); //[1,2,3]
    Array.from(s);

    //删除数组的重复成员
    function delArrayRepeatVal(arr) {
        return [].concat((0, _toConsumableArray3.default)(new Set(arr)));
    }
    ...
    //map转化为数组
    [].concat((0, _toConsumableArray3.default)(m1)); //[[ "t1",12],["t2",34]]
